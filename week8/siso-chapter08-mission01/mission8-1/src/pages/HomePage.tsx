...
const HomePage = () => {
  ...
  const {
    ...
    fetchNextPage,
    isError,
  } = useGetInfiniteLpList(10, debouncedValue, "asc" /*PAGINATION_ORDER.asc*/);
  ...
  }, [inView, isFetching, hasNextPage, fetchNextPage, debouncedValue]);
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      <input
        className={"border p-4 rounded-sm mt-8"}
