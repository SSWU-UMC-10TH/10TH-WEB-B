...
const MovieFilter = ({ onChange }: MovieFilterProps) => {
  ...
  return (
    ...
    p-6 shadow-wl transition-all hover:shadow-2xl"
    >
      <div className="flex fkex-wrap gap-6">
        <div className="min-w-[450px] flex-1">
          <label className="mb-2 clock text-sm font-medium text-gray-700">
            영화제목
          </label>
        ...
        <div className="min-w-[250px] flex-1">
          ...
          <SelectBox
            ...
            label="성인 콘텐츠 표시"
            id="include_adult"
            className="w-full rounded-lf border border-gray-300 px-4 py-2
