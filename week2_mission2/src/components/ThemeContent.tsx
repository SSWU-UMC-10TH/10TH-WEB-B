    ...
    return (
        <div className={clsx("p-4 h-dvh w-full", isLightMode ? "bg-white" : "bg-gray-800")}>
            ...
            <p className={clsx("mt-2", isLightMode ? "text-black" : "text-white")}>
                ...
                necessitatibus deserunt, dicta error illum dolorem natus aliquid nihil dolore,
                repellat voluptate magni. Repellendus unde qui error fuga consectetur eligendi!
            </p>
        </div>
    );
}
